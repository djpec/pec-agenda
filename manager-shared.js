...
(() => {
  ...
  function shell(){
    ...
    bar.innerHTML='<a href="./">Início</a><a href="./agenda.html">Agenda</a><a href="./orcamentos.html">Orçamentos</a><a href="./contratos.html">Contratos</a><button type="button" id="pmAppearance">Aparência</button>';
